...
const socialLinks = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/vertofi/posts/?feedView=all",
    svg: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/vertofi?igsh=ZDdwdWFwY3YwbDZk",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-zinc-900 bg-zinc-950/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl h-16 items-center px-4 sm:px-6 lg:px-8">
          ...
          {navLinks.map((link) => (
            <Link
              ...
              className={`text-lg font-semibold transition-colors hover:text-white ${
                isActive(link.href) ? "text-indigo-400" : "text-zinc-300"
              }`}
            >
              {link.name}
            </Link>
        ...
        <div className="flex md:hidden ml-auto">
          <button
            ...
            className="text-zinc-400 hover:text-white focus:outline-none p-1.5 rounded-lg hover:bg-zinc-900 transition-colors"
          >
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden border-b border-zinc-900 bg-zinc-950 px-4 py-4 flex flex-col gap-4">
